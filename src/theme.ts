...
export const colors = {
  ...
  buyDim: 'rgba(245,69,92,0.45)', // 매수 '주문완료(미체결)' — 체결 전이라 흐린 빨강
  sellDim: 'rgba(59,130,246,0.45)', // 매도 '주문완료(미체결)' — 체결 전이라 흐린 파랑
...
// =====================================================================
// 글자 크기·굵기 — 앱 전체가 같은 몇 단계만 쓰도록 (화면마다 제각각이면 정신없어 보인다)
//   · h1 22  화면 제목 / 큰 금액        · h2 16  카드 제목
//   · body 14 본문·값                   · sm 12  보조 설명 · 배지
//   · xs 11  각주                       · price 26~38 은 실시간 현재가에만
//   굵기: 제목·값 = bold(800), 강조 숫자(현재가·손익) = black(900), 설명 = regular
// =====================================================================
export const fs = { h1: 22, h2: 16, body: 14, sm: 12, xs: 11 } as const;
export const fw = { black: '900', bold: '800', semi: '700', regular: '400' } as const;

/** 색에 투명도를 얹은 옅은 배경 — 'rgba(…)' 를 화면마다 손으로 적지 않게 */
